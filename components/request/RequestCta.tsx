// components/request/RequestCta.tsx
'use client';

import { memo } from 'react';
import Link from 'next/link';
import { Phone, MessageCircle } from 'lucide-react';
import type { RequestCtaProps } from './types';

export const RequestCta = memo(({ t }: RequestCtaProps) => {
  return (
...
RequestCta.displayName = 'RequestCta';