  ...
  return (
    <div className="bg-[#1e293b] rounded-lg overflow-hidden border border-gray-800 hover:border-orange-500 transition">
      ...
      <div className="p-4">
        ...
        <Link href="#" className="mt-4 block w-full border border-orange-500/50 hover:border-orange-500 text-orange-500 hover:text-white hover:bg-orange-500 px-4 py-2 rounded text-xs font-bold text-center transition">
